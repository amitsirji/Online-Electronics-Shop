<?php
	session_start();
	$_SESSION['file_name']="lg_plasma_tv_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Plasma Television Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_plasma_tv where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Plasma Television</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
															...
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		...
																		<input type='hidden' value='lg_plasma_tv' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Audio Features</b><br><br>Audio Output</td> <td><br><br><br><br>".$detail[7]."</td>
												</tr>
												<tr>
													<td>Number of Speakers</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Surround System</td> <td>Infinite</td>
												</tr>
												...
												<tr>
													<td>Color Reproduction (RGB)</td> <td>16 bit Color</td>
												</tr>
												<tr>
													<td>Viewing Angle (degree)</td> <td>178 / 178</td>
												</tr>
												<tr>
													<td>Life Span (Hrs)</td> <td>100000</td>
												</tr>
												<tr>

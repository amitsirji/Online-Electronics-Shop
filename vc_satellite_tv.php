<?php
	session_start();
	$_SESSION['file_name']="vc_satellite_tv.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Satellite Television</title>
						...
						<td >
							<table border="0"><tr><td style="background:url(image/product_title_bg_1.jpg); width:700px;">
								<div style="float:left;">
									<table border="0"  height="40px" style="font-family:Arial; font-size:24px; color:#51740C;">
										<tr>
											<td>Videocon Satellite Television</td>
										</tr>
									</table>
								</div>
							...
							<?php
								...
								$temp=0;
								$col=0;
								$result=mysql_query("select * from vc_satellite_tv");

								$count=mysql_query("select * from vc_satellite_tv");
								...
								<table border='0' style='border-color:#FF0000;'>
									...
									{	
										if($col<=2)
										{
											...
											echo " <tr><td height='100px'><center><a href='vc_satellite_tv_detail.php ? id=$data[0]'><img height='100px'  src=".$data[2]." style='border:none;'></a></center></td></tr>
											
											  <tr><td height='40px' class='font_size_12px' style='color:#618A10; border-bottom:1px solid #E4F9BB;'><center><b>".$data[1]."</b></center></td></tr>
											  
											  <tr><td height='120px' class='font_size_12px'><center><p align='left' style='padding: 0 0 0 15px; border-bottom:1px solid #E4F9BB;'>Resolution : ".$data[3]."<br>Contrast Ratio : ". $data[5]."<br>Color : ". $data[4]." color<br>Technical : ".$data[7]." </p></center></td></tr>

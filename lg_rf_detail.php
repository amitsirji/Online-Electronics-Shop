<?php
	session_start();
	$_SESSION['file_name']="lg_rf_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Refrigerator Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_rf where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Refrigerator</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Capacity : ".$detail[3]."<br>Cooling Technology : ".$detail[4]."<br>Temperature Control : ".$detail[5]."<br>Color : ".$detail[8]."<br>Humidity Controller : Yes</p><td>
															</tr>
															<tr>
																	...
																	<table border='0' style='float:right;'>
																		<tr>
																			<form action='add_to_cart.php' method='POST'>
																				...
																				<input type='hidden' value='lg_rf' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Highlight</b><br><br>Cooling Technology</td> <td><br><br><br><br>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Temperature Control </td><td>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Door Finish</td> <td>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Door Type</td> <td>".$detail[7]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Other Features</b> <br><br> Ice Bank </td> <td> <br><br><br><br>Yes</td>
												</tr>
												<tr>
													<td>Freezer Lamp</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Color</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Lock</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Humidity Controller</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Anti Bacteria Gasket</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Shelf Type</td> <td>".$detail[9]."</td>
												</tr>
												<tr>
													<td>Vitamin Plus</td> <td>Yes</td>
												</tr>
									  </table>";
							}
						?>

<?php
	session_start();
	$_SESSION['file_name']="lg_lcd_tv_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG LCD Television Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_lcd_tv where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG LCD Television</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Size : ".$detail[3]."''<br>Resolution : ".$detail[4]."<br>Brightness : ".$detail[5]."<br>Contrast Ratio : ".$detail[6]."<br>Audio Output : ".$detail[7]."</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		...
																		<input type='hidden' value='lg_lcd_tv' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Audio Features</b><br><br>Voice</td> <td><br><br><br><br>Clear Voice II</td>
												</tr>
												<tr>
													<td>System</td> <td>Mono/Stereo/Dual</td>
												</tr>
												<tr>
													<td>Audio Output</td> <td>".$detail[7]."</td>
												</tr>
												<tr>
													<td>Number of Speakers</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Dolby Digital Decoder</td> <td>Yes</td>
												</tr>
												...
												<tr>
													<td>Color Reproduction (RGB)</td> <td>10 bit Color</td>
												</tr>
												<tr>
													<td>Viewing Angle (degree)</td> <td>178 / 178</td>
												</tr>
												<tr>
													<td>Life Span (Hrs)</td> <td>60000</td>
												</tr>
												<tr>
													<td>Contrast</td> <td>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Brightness</td> <td>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Screen Size Range</td> <td>".$detail[3]."</td>
												</tr>

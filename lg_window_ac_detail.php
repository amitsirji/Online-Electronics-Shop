<?php
	session_start();
	$_SESSION['file_name']="lg_window_ac_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Window AC Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_window_ac where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Window AC</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																...
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[10]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[11]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Ton : ".$detail[3]."<br>Cooling (watt) : ".$detail[4]."<br>EER : ".$detail[6]."<br>Air circulation (In/Out)(CFM) : ".$detail[6]."<br>Compressor :  Rotary</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='lg_window_ac' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Highlights</b><br><br>Cooling (watt)</td> <td><br><br><br><br>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Compressor</td> <td>Rotary</td>
												</tr>
												<tr>
													<td>Power Supply(Volt/Phase/Hz.)</td> <td>230 / Single / 50</td>
												</tr>
												<tr>
													<td>Power Input (Watts)</td> <td>".$detail[8]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Performance</b> <br><br>EER (W/W)</td> <td> <br><br><br><br>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Air circulation (In/Out)(CFM)</td> <td>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Noise Level (Indoor)(db)</td> <td>".$detail[7]."</td>
												</tr>
												<tr>
													<td>Anti-Bacteria Filter</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Auto Air Swing </td> <td>Yes</td>
												</tr>
												<tr>
													<td>Temp. Control</td> <td>Thermistor</td>
												</tr>
												<tr>
													<td>Remote Control</td> <td>Simple LCD</td>
												</tr>
												<tr>
													<td>Air Direction</td> <td>4 Way Air Deflection</td>
												</tr>
												
												
												<tr>
													<td><br><br><b>Other Functions</b><br><br>Speed Setting</td> <td><br><br><br><br>3/3</td>
												</tr>
												<tr>
													<td>Auto Restart</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Sleep mode</td> <td>With Sleep mode</td>
												</tr>
												<tr>
													<td>On Timer</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Off Timer</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Dehumidification</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Operation Control</td> <td>Electronic</td>
												</tr>
												<tr>
													<td>Energy saver</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Night Glow Buttons On Remote</td> <td>Yes</td>
												</tr>
									  </table>";
							}
						?>

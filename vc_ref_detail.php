<?php
	session_start();
	$_SESSION['file_name']="vc_ref_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Refrigerator Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_ref where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon Refrigerator</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																...
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[5]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[6]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Litres : ".$detail[3]."<br>".$detail[4]."</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='vc_ref' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td>Litres</td> <td>".$detail[3]." Litres</td>
												</tr>
												<tr>
													<td>Brand</td><td>VIDEOCON</td>
												</tr>
												<tr>
													<td style='border-bottom:none;'><br><br><b>Details</b></td><td></td>
												</tr>
												<tr>
													<td><br></td><td> <table border='0' width='150px' style='font-family:Arial; font-size:13px; color:#30410F;'><tr><td style='border-bottom:none;'>".$detail[4]."</td></tr></table></td>
												</tr>
										</table>";
								}			
							?>

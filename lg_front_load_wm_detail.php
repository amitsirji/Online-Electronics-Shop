<?php
	session_start();
	$_SESSION['file_name']="lg_front_load_wm_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Front Load Washing Machine Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_front_load_wm where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Front Load Washing Machine</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Capacity (kg) : ".$detail[3]."<br>Door Diameter (mm) : 300<br>Quick 30 Program : Yes<br>Color : ".$detail[4]."<br>Temperature Range : ".$detail[5]."</p><td>
															</tr>
															<tr>
																	...
																	<table border='0' style='float:right;'>
																		<tr>
																			<form action='add_to_cart.php' method='POST'>
																				...
																				<input type='hidden' value='lg_front_load_wm' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td>Capacity (kg)</td> <td>".$detail[3]."'' inch</td>
												</tr>
												<tr>
												...
												<tr>
													<td><br><br><b>HighLights</b><br><br>Door Diameter (mm)</td> <td><br><br><br><br>300</td>
												</tr>
												<tr>
													<td>Fuzzy logic</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Quick 30 Program</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Crease Care</td> <td>With Crease Care</td>
												</tr>
												<tr>
													<td>Rinse Hold</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Pre Wash</td> <td>Yes</td>
												</tr>
												<tr>
												...
												<tr>
													<td> <br><br> <b>General Specifications</b> <br><br> Temperature Range </td> <td> <br><br><br><br>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Spin Speed options</td> <td>4</td>
												</tr>
												<tr>
													<td>Wash Programs 1</td> <td>Cotton / Baby care / Synthetic / Delicate / Handwash</td>
												</tr>
												<tr>
													<td>Wash Programs 2</td> <td>Wool / Only Spin / Blanket</td>
												</tr>
												<tr>
													<td>Child Lock</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Intensive wash</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Time Delay</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Door Opening Angle</td> <td>180 Deg</td>
												</tr>
										</table>";
							}
						?>

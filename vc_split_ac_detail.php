<?php
	session_start();
	$_SESSION['file_name']="vc_split_ac_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Split AC Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_split_ac where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon Split AC</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Ton : ".$detail[3].", &nbsp; &nbsp; USP : ".$detail[4]."<br>Anti- Bacteria Filter<br>Cooling Mode : ".$detail[5]."<br>Cooling Capacity : ".$detail[6]."<br>Power Input : ".$detail[7]."<br>EER : ".$detail[8]."</p><td>
															</tr>
															<tr>
...
<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='vc_split_ac' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Cooling Features</b><br><br>Cooling Mode</td> <td><br><br><br><br>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Cooling Capacity</td> <td>".$detail[6]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Technical Features</b> <br><br> USP </td> <td> <br><br><br><br>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Power Input</td> <td>".$detail[7]."</td>
												</tr>
												<tr>
													<td>EER</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Sleep Timer</td> <td>With Sleep Timer</td>
												</tr>
												<tr>
													<td>Restart</td> <td>Auto Restart</td>
												</tr>
												<tr>
													<td>Timer</td> <td>On / Off Timer</td>
												</tr>
												<tr>
													<td>Remote Control</td> <td>With Remote Control</td>
												</tr>
								  </table>";
						}			
					?>

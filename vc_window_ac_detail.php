<?php
	session_start();
	$_SESSION['file_name']="vc_window_ac_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Window AC Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_window_ac where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon Window AC</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																...
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[7]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[8]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Ton : ".$detail[3].", &nbsp; &nbsp; <br>Anti- Bacteria Filter<br>Cooling Capacity : ".$detail[4]."<br>Power Input : ".$detail[5]."<br>EER : ".$detail[6]."<br>Auto - Restart</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='vc_window_ac' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Cooling Features</b><br><br>Cooling Capacity</td> <td><br><br><br><br>".$detail[6]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Technical Features</b> <br><br> Power Input </td> <td> <br><br><br><br>".$detail[5]."</td>
												</tr>
												<tr>
													<td>EER</td> <td>".$detail[6]."</td>
												</tr>
												<tr>

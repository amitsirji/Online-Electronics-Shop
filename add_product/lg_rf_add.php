...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/lg_rf/".$id.".jpg";
		
		$capacity =$_POST['capacity'];
		$colling =$_POST['colling'];
		$temperature_control =$_POST['temperature_control'];
		$door_finish =$_POST['door_finish'];
		...
		mysql_query("insert into lg_rf values('$id','$name','$path','$capacity','$colling','$temperature_control','$door_finish','$door_type','$color','$shelf_type','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/lg_rf//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='lg_rf_add.php';</script>";
		}
	}	

?>
<h1><u>LG Refrigerator<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			<th style="border-bottom:double;">Inserted ID List <br><br></th>
				...
				<?php
					$id_arr=mysql_query("select id from lg_rf");
		...
		<form action="lg_rf_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200px">
				...
				<tr>
					<td>Colling</td>
					<td><input type="text" class="text_box" id="id5" name="colling" maxlength="40"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Temperature Control</td>
					<td><input type="text" class="text_box" id="id6" name="temperature_control" maxlength="30"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Door Finish</td>
					<td><input type="text" class="text_box" id="id7" name="door_finish" maxlength="30"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>Door Type</td>
					<td><input type="text" class="text_box" id="id8" name="door_type" maxlength="30"></td>
					<td id="error_8" class="error">*</td>
				</tr>
				<tr>
					<td>Color</td>
					<td><input type="text" class="text_box" id="id9" name="color" maxlength="40"></td>
					<td id="error_9" class="error">*</td>
				</tr>
				<tr>
					<td>Shelf Type</td>
					<td><input type="text" class="text_box" id="id10" name="shelf_type" maxlength="40"></td>

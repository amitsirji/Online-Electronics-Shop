...
?>
<h1><u>Videocon Satellite Television<br></u></h1> <!--    Change   !-->
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from vc_satellite_tv where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from vc_satellite_tv");   //change
	
	echo "<form action='vc_satellite_tv_del.php' method='post'>";    //change

...
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from vc_standard_tv where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from vc_standard_tv");   //change
	
	echo "<form action='vc_standard_tv_del.php' method='post'>";    //change

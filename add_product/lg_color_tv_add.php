...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/lg_color_tv/".$id.".jpg";
		
		$size =$_POST['size'];
		$type =$_POST['type'];
		$cabinet_finish =$_POST['cabinet_finish'];
		...
		mysql_query("insert into lg_color_tv values('$id','$name','$path','$size','$type','$cabinet_finish','$sound_output','$woofer','$sound_system','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/lg_color_tv//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='lg_color_tv_add.php';</script>";
		}
	}	

?>
<h1><u>LG Color Television<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;">
			<th style="border-bottom:double;">Inserted ID List <br><br></th>
				...
				<?php
					$id_arr=mysql_query("select id from lg_color_tv");
		...
		<form action="lg_color_tv_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200px">
				...
				<tr>
					<td>Type</td>
					<td><input type="text" class="text_box" id="id5" name="type" maxlength="20"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Cabinet Finish</td>
					<td><input type="text" class="text_box" id="id6" name="cabinet_finish" maxlength="20"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Sound Output</td>
					<td><input type="text" class="text_box" id="id7" name="sound_output" maxlength="4"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>Woofer</td>
					<td><input type="text" class="text_box" id="id8" name="woofer" maxlength="25"></td>
					<td id="error_8" class="error">*</td>
				</tr>
				<tr>
					<td>Sound System</td>
					<td><input type="text" class="text_box" id="id9" name="sound_system" maxlength="20"></td>

...
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from lg_top_load_wm where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from lg_top_load_wm");   //change
	
	echo "<form action='lg_top_load_wm_del.php' method='post'>";    //change

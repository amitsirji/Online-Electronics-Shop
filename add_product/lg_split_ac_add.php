...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/lg_split_ac/".$id.".jpg";
		...
		mysql_query("insert into lg_split_ac values('$id','$name','$path','$ton','$colling','$power_input','$eer','$air_circulation','$noise_level','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/lg_split_ac//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='lg_split_ac_add.php';</script>";
		}
	}	

?>
<h1><u>LG Split AC<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			<th style="border-bottom:double;">Inserted ID List <br><br></th>
				...
				<?php
					$id_arr=mysql_query("select id from lg_split_ac");
		...
		<form action="lg_split_ac_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200px">
				...
				<tr>
					<td>Colling</td>
					<td><input type="text" class="text_box" id="id5" name="colling" maxlength="4"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Power Input</td>
					<td><input type="text" class="text_box" id="id6" name="power_input" maxlength="15"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>EER</td>
					<td><input type="text" class="text_box" id="id7" name="eer" maxlength="15"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>Air Circulation</td>
					<td><input type="text" class="text_box" id="id8" name="air_circulation" maxlength="15"></td>
					<td id="error_8" class="error">*</td>
				</tr>
				<tr>
					<td>Noise Level</td>
					<td><input type="text" class="text_box" id="id9" name="noise_level" maxlength="4"></td>

...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/vc_split_ac/".$id.".jpg";
		
		$ton =$_POST['ton'];
		$usp =$_POST['usp'];
		$colling_mode =$_POST['colling_mode'];
		...
		mysql_query("insert into vc_split_ac values('$id','$name','$path','$ton','$usp','$colling_mode','$colling_capacity','$power_input','$eer','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/vc_split_ac//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='vc_split_ac_add.php';</script>";
		}
	}	

?>
<h1><u>Videocon Split AC<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			...
			<?php
				$id_arr=mysql_query("select id from vc_split_ac");
		...
		<form action="vc_split_ac_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200PX">
				...
				<tr>
					<td>Usp</td>
					<td><input type="text" class="text_box" id="id5" name="usp" maxlength="25"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Colling Mode</td>
					<td><input type="text" class="text_box" id="id6" name="colling_mode" maxlength="30"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Colling Capacity</td>
					<td><input type="text" class="text_box" id="id7" name="colling_capacity" maxlength="5"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>Power Input</td>
					<td><input type="text" class="text_box" id="id8" name="power_input" maxlength="5"></td>
					<td id="error_8" class="error">*</td>
				</tr>
				<tr>
					<td>Eer</td>
					<td><input type="text" class="text_box" id="id9" name="eer" maxlength="5"></td>

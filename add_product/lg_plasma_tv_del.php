...
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from lg_plasma_tv where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from lg_plasma_tv");   //change
	
	echo "<form action='lg_plasma_tv_del.php' method='post'>";    //change

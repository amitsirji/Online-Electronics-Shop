...
function validate()
{
	var main_mrp =document.getElementById("id10").value;
	if(isNaN(main_mrp))
	{
		document.getElementById("error_10").style.visibility="visible";
		return false;
	}
...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/vc_window_ac/".$id.".jpg";
		
		$ton =$_POST['ton'];
		$colling_capacity =$_POST['colling_capacity'];
		...
		mysql_query("insert into vc_window_ac values('$id','$name','$path','$ton','$colling_capacity','$power_input','$eer','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/vc_window_ac//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='vc_window_ac_add.php';</script>";
		}
	}	

?>
<h1><u>Videocon Window AC<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			...
			<?php
				$id_arr=mysql_query("select id from vc_window_ac");
		...
		<form action="vc_window_ac_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200PX">
				...
				<tr>
					<td>Ton</td>
					<td><input type="text" class="text_box" id="id4" name="ton" maxlength="10"></td>
					<td id="error_4" class="error">*</td>
				</tr>
				<tr>
					<td>Colling Capacity</td>
					<td><input type="text" class="text_box" id="id5" name="colling_capacity" maxlength="5"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Power Input</td>
					<td><input type="text" class="text_box" id="id6" name="power_input" maxlength="5"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Eer</td>
					<td><input type="text" class="text_box" id="id7" name="eer" maxlength="5"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>MRP</td>
					<td><input type="text" class="text_box" id="id8" name="mrp" maxlength="10"></td>
					<td id="error_8" class="error">*</td>
				</tr>
				<tr>
					<td>New MRP</td>
					<td><input type="text" class="text_box" id="id9" name="new_mrp" maxlength="10"></td>
					<td id="error_9" class="error">*</td>
				</tr>
				<tr>
					<td>Main MRP</td>
					<td><input type="text" class="text_box" id="id10" name="main_mrp" maxlength="5"></td>

...
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from vc_window_ac where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from vc_window_ac");   //change
	
	echo "<form action='vc_window_ac_del.php' method='post'>";    //change

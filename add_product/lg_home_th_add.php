...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/lg_home_th/".$id.".jpg";
		
		$sound_output =$_POST['sound_output'];
		$speaker_type =$_POST['speaker_type'];
		$woffer_output =$_POST['woffer_output'];
		$amplifier =$_POST['amplifier'];
		$audio_line =$_POST['audio_line'];
		$mrp =$_POST['mrp'];
		$new_mrp =$_POST['new_mrp'];
		$main_mrp =$_POST['main_mrp'];
		
		mysql_query("insert into lg_home_th values('$id','$name','$path','$sound_output','$speaker_type','$woffer_output','$amplifier','$audio_line','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/lg_home_th//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='lg_home_th_add.php';</script>";
		}
	}	

?>
<h1><u>LG Home Theater System<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			<th style="border-bottom:double;">Inserted ID List <br><br></th>
				...
				<?php
					$id_arr=mysql_query("select id from lg_home_th");
		...
		<form action="lg_home_th_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0"  style="margin-right:200px">
				...
				<tr>
					<td>Sound Output</td>
					<td><input type="text" class="text_box" id="id4" name="sound_output" maxlength="4"></td>
					<td id="error_4" class="error">*</td>
				</tr>
				<tr>
					<td>Speaker Type</td>
					<td><input type="text" class="text_box" id="id5" name="speaker_type" maxlength="40"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Woffer Output</td>
					<td><input type="text" class="text_box" id="id6" name="woffer_output" maxlength="40"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Amplifier</td>
					<td><input type="text" class="text_box" id="id7" name="amplifier" maxlength="40"></td>
					<td id="error_7" class="error">*</td>
				</tr>
				<tr>
					<td>Audio Line</td>
					<td><input type="text" class="text_box" id="id8" name="audio_line" maxlength="20"></td>

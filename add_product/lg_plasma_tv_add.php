...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/lg_plasma_tv/".$id.".jpg";
		...
		mysql_query("insert into lg_plasma_tv values('$id','$name','$path','$size','$resolution','$brightness','$contrast_ratio','$audio_output','$speaker','$mrp','$new_mrp','$main_mrp')");
		
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/lg_plasma_tv//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='lg_plasma_tv_add.php';</script>";
		}
	}	

?>
<h1><u>LG Plasma Television<br></u></h1>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			<th style="border-bottom:double;">Inserted ID List <br><br></th>
				...
				<?php
					$id_arr=mysql_query("select id from lg_plasma_tv");
		...
		<form action="lg_plasma_tv_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200px">
				...
				<tr>
					...
					<td><input type="text" class="text_box" id="id7" name="contrast_ratio" maxlength="20"></td>
				...
				<tr>
					<td>Speaker</td>
					<td><input type="text" class="text_box" id="id9" name="speaker" maxlength="1"></td>
					<td id="error_9" class="error">*</td>
				</tr>
				<tr>
					<td>MRP</td>
					<td><input type="text" class="text_box" id="id10" name="mrp" maxlength="12"></td>
					<td id="error_10" class="error">*</td>
				</tr>
				<tr>
					<td>New MRP</td>
					<td><input type="text" class="text_box" id="id11" name="new_mrp" maxlength="12"></td>
					<td id="error_11" class="error">*</td>
				</tr>
				<tr>
					<td>Main MRP</td>
					<td><input type="text" class="text_box" id="id12" name="main_mrp" maxlength="6"></td>

...
<?php
	...
	if(isset ($_POST['id']))
	{
		$id=$_POST['id'];
		$name=$_POST['name'];
		$path="product_img/vc_standard_tv/".$id.".jpg";
		
		$size =$_POST['size'];
		$screen_size_range =$_POST['screen_size_range'];
		$screen_type =$_POST['screen_type'];
		$audio_type =$_POST['audio_type'];
		$audio_output =$_POST['audio_output'];
		$audio_output_range =$_POST['audio_output_range'];
		$sound_leveler =$_POST['sound_leveler'];
		$other =$_POST['other'];
		$mrp =$_POST['mrp'];
		...
		mysql_query("insert into vc_standard_tv values('$id','$name','$path','$size','$screen_size_range','$screen_type','$audio_type','$audio_output','$audio_output_range','$sound_leveler','$other','$mrp','$new_mrp','$main_mrp')")or die ("error");
				
		if(mysql_affected_rows()>0)
		{
			copy($_FILES['file']['tmp_name'],"../product_img/vc_standard_tv//".$id.".jpg");
		}
		else
		{
			echo"<script>
					alert('ID is Duplicat ! Record not Insert');
					window.location='vc_standard_tv_add.php';</script>";
		}
	}	

?>
<h1><u>Videocon Standard Television<br></u></h1>
	...
	<center><b>New Record</b><br><br></center>
		...
		<table border="0" style="float:left; margin-left:100px; border:double;"> 
			...
			<?php
				$id_arr=mysql_query("select id from vc_standard_tv");
		...
		<form action="vc_standard_tv_add.php" method="post" enctype="multipart/form-data" onSubmit="return validate()">
			<table border="0" style="margin-right:200px">
				...
				<tr>
					...
					<td><input type="text" class="text_box" id="id5" name="screen_size_range" maxlength="20"></td>
					<td id="error_5" class="error">*</td>
				</tr>
				<tr>
					<td>Screen Type</td>
					<td><input type="text" class="text_box" id="id6" name="screen_type" maxlength="20"></td>
					<td id="error_6" class="error">*</td>
				</tr>
				<tr>
					<td>Audio Type</td>
					<td><input type="text" class="text_box" id="id7" name="audio_type" maxlength="30"></td>
				...
				<tr>
					<td>Audio Output Range</td>
					<td><input type="text" class="text_box" id="id9" name="audio_output_range" maxlength="25"></td>
					<td id="error_9" class="error">*</td>
				</tr>
				<tr>
					<td>Sound Leveler</td>
					<td><input type="text" class="text_box" id="id10" name="sound_leveler" maxlength="40"></td>
					<td id="error_10" class="error">*</td>
				</tr>
				<tr>
					<td>Other</td>
					<td><input type="text" class="text_box" id="id11" name="other" maxlength="70"></td>

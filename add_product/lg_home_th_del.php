...
?>
<h1><u>LG Home Theater Systems<br></u></h1>
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from lg_home_th where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from lg_home_th");   //change
	
	echo "<form action='lg_home_th_del.php' method='post'>";    //change

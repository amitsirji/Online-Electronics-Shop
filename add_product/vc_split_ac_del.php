...
<?php
	...
	if(isset ($_POST['a1']))
	{
		...
		{
			mysql_query("delete from vc_split_ac where id='$value'");   //Change
		}
	}

	
	$result=mysql_query("select * from vc_split_ac");   //change
	
	echo "<form action='vc_split_ac_del.php' method='post'>";    //change

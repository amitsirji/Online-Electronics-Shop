<?php
	session_start();
	$_SESSION['file_name']="vc_split_ac.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Split AC</title>
					...
					<tr>
						<td >
							...
							<?php
								...
								$temp=0;
								$col=0;
								$result=mysql_query("select * from vc_split_ac");

								$count=mysql_query("select * from vc_split_ac");
								...
								<table border='0' style='border-color:#FF0000;'>
									...
									{	
										if($col<=2)
										{
											...
											echo " <tr><td height='120px'><center><a href='vc_split_ac_detail.php ? id=$data[0]'><img height='100px'  src=".$data[2]." style='border:none;'></a></center></td></tr>
											
											  <tr><td height='40px' class='font_size_12px' style='color:#618A10; border-bottom:1px solid #E4F9BB;'><center><b>".$data[1]."</b></center></td></tr>
											  
											  <tr><td height='120px' class='font_size_12px'><center><p align='left' style='padding: 5px 0 0 15px; border-bottom:1px solid #E4F9BB;'>Ton : ".$data[3]."<br>USP : ". $data[4]."<br>Cooling Mode : ". $data[5]."<br>Cooling Capacity : ". $data[6]."</p></center></td></tr>

<?php
	session_start();
	$_SESSION['file_name']="lg_window_ac.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Window AC</title>
					...
					<tr>
						<td >
							<table border="0"><tr><td style="background:url(image/product_title_bg_1.jpg); width:700px;">
								<div style="float:left;"><table border="0"  height="40px" style="font-family:Arial; font-size:24px; color:#51740C;"><tr><td>LG Window AC</td></tr></table></div>
							...
							<?php
								...
								$temp=0;
								$col=0;
								$result=mysql_query("select * from lg_window_ac ");

								$count=mysql_query("select * from lg_window_ac");
								...
								<table border='0' style='border-color:#FF0000;'>
									...
									{	
										if($col<=2)
										{
											...
											echo " <tr><td height='120px'><center><a href='lg_window_ac_detail.php ? id=$data[0]'><img height='100px'  src=".$data[2]." style='border:none;'></a></center></td></tr>
											
											  <tr><td height='40px' class='font_size_12px' style='color:#618A10; border-bottom:1px solid #E4F9BB;'><center><b>".$data[1]."</b></center></td></tr>
											  
											  <tr><td height='120px' class='font_size_12px'><center><p align='left' style='padding: 5px 0 0 15px; border-bottom:1px solid #E4F9BB;'>Ton : ".$data[3]."<br>Colling (watt): ". $data[4]."<br>EER (BTU / Hr./W): ". $data[5]."<br>Air circulation : ".$data[6]."<br>Anti-Bacteria Filter : Yes</p></center></td></tr>
											  
											  <tr><td class='font_size_12px'><center><b><div style='color:#618A10; float:right; text-decoration:line-through;'> ".$data[10]." Rs.</div><div style='float:right;'>MRP : &nbsp; </div></b></center></td></tr>
											  
											  <tr><td class='font_size_12px'><center><b><div style='color:#618A10; float:right;'> ".$data[11]." Rs.</div><div style='float:right;'>Now at : &nbsp; </div></center></b></td></tr>";
											echo "</table>";

<?php
	session_start();
	$_SESSION['file_name']="vc_lcd_tv_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon LCD Television Detail</title>
<style>
.product_features td
{
...
<center>
	...
	<table border="0" width="960px" bgcolor="#FFFFFF" style="margin-top:-2px;" >
		<tr>
			<td ><div style="float:right; height:30px; font-size:14px; font-family:Arial; color:#9aca3a"><b>
		<?php 
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_lcd_tv where id='$product_id'");
				?>
				<?php
						...
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
								<tr>
									<td>
										<table border='0'>
											<tr>
												<td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon LCD Television
												</td>
											</tr>
										</table>
									</td>
											...
											<tr>
												...
												<td>
													<center>
														...
														<tr>
															<td height='10px' style='font-family:Arial; font-size:14px; border-bottom:1px solid #9aca3a;'><b>Brand : VIDEOCON</b>
															</td>
														</tr>
														<tr>
															<td height='60px' style='border-bottom:1px solid #9aca3a;'>
																<table style='font-family:Arial; font-size:14px;'>
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[11]." Rs</b>
																	</td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b>
																	</td>
																	<td style='color:#7E886A'><b>".$detail[12]." Rs</b>
																	</td>
																</tr>
																</table>
															</td>
														...
														<tr>
															<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Size : ".$detail[3]."''<br>Resolution : ".$detail[4]."<br>Audio type : ".$detail[5]."<br>Color : ".$detail[6]." Color<br>Brightness : ".$detail[8]."</p>
															<td>
														</tr>
														<tr>
															...
															<tr>
																<form action='add_to_cart.php' method='POST'>
																	...
																	<input type='hidden' value='vc_lcd_tv' name='table'>
								...
								<tr>
									<td><br>
										...
										<tr>
											<td><br><br><b>Audio Features</b><br><br>Audio Type</td> <td><br><br><br><br>".$detail[5]."</td>
										</tr>
										<tr>
											<td>Audio Leveler</td> <td>Auto Volume Leveller</td>
										</tr>
										<tr>
											<td>Audio Output</td> <td>Variable / Fixed</td>
										</tr>
										<tr>
											<td>Number of Speakers</td> <td>".$detail[10]."</td>
										</tr>
										<tr>
											<td> <br><br> <b>Display Features</b> <br><br> Resolution </td> <td> <br><br><br><br>".$detail[4]."</td>
										</tr>
										<tr>
											<td>Color</td> <td>".$detail[6]." Color</td>
										</tr>
										<tr>
											<td>Contrast</td> <td>".$detail[7]."</td>
										</tr>
										<tr>
											<td>Brightness</td> <td>".$detail[8]."</td>
										</tr>
										<tr>
											<td>Screen Size Range</td> <td>".$detail[9]."</td>
										</tr>
										<tr>

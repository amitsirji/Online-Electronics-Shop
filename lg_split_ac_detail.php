<?php
	session_start();
	$_SESSION['file_name']="lg_split_ac_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Split AC Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_split_ac where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Split AC</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Ton : ".$detail[3]."<br>Colling : ".$detail[4]."<br>EER : ".$detail[6]."<br>Air circulation (In/Out)(CFM) : ".$detail[7]."<br>Compressor :  Rotary</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='lg_split_ac' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td><br><br><b>Highlights</b><br><br>Cooling</td> <td><br><br><br><br>".$detail[4]." Watt</td>
												</tr>
												<tr>
												...
												<tr>
													<td>Power Input (Watts)</td> <td>".$detail[5]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Performance</b> <br><br>EER (W/W)</td> <td> <br><br><br><br>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Air circulation (In/Out)(CFM)</td> <td>".$detail[7]."</td>
												</tr>
												<tr>
													<td>Noise Level (Indoor)(db)</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Anti-Bacteria Filter</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Auto Air Swing (Up-Down)</td> <td>Auto</td>
												</tr>
												<tr>
													<td>Auto Air Swing (Left-Right)</td> <td>Auto</td>
												</tr>
												<tr>
													<td>Remote Control</td> <td>Flap LCD</td>
												</tr>
												
												
												<tr>
													<td><br><br><b>Other Functions</b><br><br>Speed Setting</td> <td><br><br><br><br>4/3</td>
												</tr>
												<tr>
												...
												<tr>
													<td>Chaos Logic</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Fuzzy Logic</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Jet Cool</td> <td>Yes</td>
												</tr>
									 </table>";
								}
							?>

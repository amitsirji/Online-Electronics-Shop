<?php
	session_start();
	$_SESSION['file_name']="vc_standard_tv_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Standard Television Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_standard_tv where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon Standard Television</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															<tr>
																<td height='50px' style='font-family:Arial; font-size:18px; color:#51740C;'>".$detail[1]."
																</td>
															</tr>
															<tr>
																<td height='10px' style='font-family:Arial; font-size:14px; border-bottom:1px solid #9aca3a;'><b>Brand : VIDEOCON</b></td>
															</tr>
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																<table style='font-family:Arial; font-size:14px;'>
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[11]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[12]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Size : ".$detail[3]."'' &nbsp; Screen type : ".$detail[5]."<br>Audio type : ".$detail[6]."<br>Audio Output : ".$detail[7]."<br>Sound leveler : ".$detail[9]."<br>Number of speakers : 2 speakers </p><td>
															</tr>
															<tr>
...
<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='vc_standard_tv' name='table'>
																				<td style='border:1px solid #9aca3a;'>
																			<input type='submit' name='by_now' value='Add to Cart' style=' background:url(image/add_to_cart_button_bg_1.jpg); width:202px;height:43px; float:right; font-size:20px; color:#3F5B07;'></form>
																				</td>
																	</tr>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td>Brand</td><td>VIDEOCON</td>
												</tr>
												
												<tr>
													<td><br><br><b>Audio Features</b><br><br>Audio Type</td> <td><br><br><br><br>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Audio Leveler</td> <td>".$detail[9]."</td>
												</tr>
												<tr>
													<td>Audio Output</td> <td>".$detail[7]."</td>
												</tr>
												<tr>
													<td>Audio Output Range</td> <td>".$detail[8]."</td>
												</tr>
												<tr>
													<td>Number of Speakers</td> <td>2 Speakers</td>
												</tr>
												<tr>
													<td>Number of Speakers Range</td> <td>1 of 2 Speakers</td>
												</tr>
											
												
												<tr>
													<td> <br><br> <b>Display Features</b> <br><br> Screen Size Range </td> <td> <br><br><br><br>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Screen Type</td> <td>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Digital TV Standard</td> <td>SDTV</td>
												</tr>
												<tr>
													<td>Adjustable Color Temperature &nbsp; &nbsp;</td> <td>With Adjustable Color Temperature</td>
												</tr>
												...
												<tr>
													<td>Picture in Picture</td> <td>No</td>
												</tr>
												<tr>
													<td>Parental Control</td> <td>With Parental Control</td>
												</tr>
												<tr>
													<td>Other</td> <td>".$detail[10]."</td>
												</tr>
										  </table>";
									}			
						?>

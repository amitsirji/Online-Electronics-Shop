<?php
	session_start();
	$_SESSION['file_name']="lg_home_th_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Home Theater Systems Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_home_th where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Home Theater System</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
												...
												<tr>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Sound Output : ".$detail[3]."<br>Speaker Type : ".$detail[4]."<br>Subwoofer Output : ".$detail[5]."<br>Amplifier : ".$detail[6]."</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		<form action='add_to_cart.php' method='POST'>
																			...
																			<input type='hidden' value='lg_home_th' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td>Sound Output</td> <td>".$detail[3]."</td>
												</tr>
												<tr>
												...
												<tr>
													<td><br><br><b>Audio Features</b><br><br>Speaker Type</td> <td><br><br><br><br>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Subwoofer output</td> <td>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Amplifier</td> <td>".$detail[6]."</td>
												</tr>
												<tr>
													<td>Audio Line IN</td> <td>".$detail[7]."</td>
												</tr>
												
												
												<tr>
													<td> <br><br> <b>Video Playback</b> <br><br> VCD </td> <td> <br><br><br><br>Yes</td>
												</tr>
												<tr>
													<td>DVD</td> <td>Yes</td>
												</tr>
												...
												<tr>
													<td>JPEG</td> <td>Yes</td>
												</tr>
												<tr>
													<td>WMA Playback</td> <td>Yes</td>
												</tr>
												<tr>
													<td>DivX Playback</td> <td>Yes</td>
												</tr>
												...
												<tr>
													<td>Connectivity Port</td> <td>USB Plus</td>
												</tr>
									 </table>";
								}
							?>

<?php
	session_start();
	$_SESSION['file_name']="vc_satellite_tv_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon Satellite Television Detail</title>
<style>
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from vc_satellite_tv where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>Videocon Satellite Television</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																...
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[8]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[9]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Resolution : ".$detail[3]."<br>Contrast Ratio : ".$detail[5]."<br>Technical : ".$detail[7]."<br>Color : ".$detail[4]." Color<br>Digital TV Standard : whih HDTV</p><td>
															</tr>
															<tr>
																...
																<table border='0' style='float:right;'>
																	<tr>
																		...
																		<input type='hidden' value='vc_satellite_tv' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td> <br><br> <b>Display Features</b> <br><br> Resolution </td> <td> <br><br><br><br>".$detail[3]."</td>
												</tr>
												<tr>
													<td>Digital TV Standard</td> <td>HD Ready</td>
												</tr>
												<tr>
													<td>Color</td> <td>".$detail[4]." Color</td>
												</tr>
												<tr>
													<td>Contrast</td> <td>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Contrast Ratio Range</td> <td>".$detail[6]."</td>
												</tr>
												<tr>

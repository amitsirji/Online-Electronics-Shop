<?php
	session_start();
	$_SESSION['file_name']="lg_top_load_wm_detail.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - LG Top Load Washing Machine Detail</title>
<style>
.product_features td
{
		...
		<tr>
			<td bgcolor="#FFFFFF" style="" >
				...
				<?php
					...
					$result=mysql_query("select * from lg_top_load_wm where id='$product_id'");
				?>
				<?php
					$detail=mysql_fetch_array($result);
					{
						echo "<table border='0' width='725px' height='5px' style='float:right;'>
									<tr>
										<td>
											<table border='0'><tr><td height='40px' width='710px' style='font-family:Arial; font-size:20px; color:#51740C; background:url(image/single_product_title_bg_1.jpg);'>LG Top Load Washing Machine</td></tr></table>
										</td>
									</tr>
									<tr>
										<td>
													...
													<td>
														...
														<table border='0' height='300px' width='375px'>
															...
															<tr><td height='60px' style='border-bottom:1px solid #9aca3a;'>
																...
																<tr>
																	<td><b>MRP : </b></td>
																	<td style='text-decoration:line-through; color:#7E886A'><b>".$detail[6]." Rs</b></td>
																	<td>&nbsp;&nbsp;&nbsp;&nbsp;<b>Now At :</b></td>
																	<td style='color:#7E886A'><b>".$detail[7]." Rs</b></td>
																</tr>
																</table>
															</td></tr>
															<tr>
																<td height='90px' style='font-family:Arial; font-size:11px; color:#7E886A;'><p>Capacity (kg) : ".$detail[3]."<br>Air Dry : With Air Dry<br>Inner Tub : Stainless Steel<br>Color : ".$detail[4]."<br>Auto Balance System : Yes</p><td>
															</tr>
															<tr>
																	...
																	<table border='0' style='float:right;'>
																		<tr>
																			<form action='add_to_cart.php' method='POST'>
																				...
																				<input type='hidden' value='lg_top_load_wm' name='table'>
									...
									<tr>
										<td><br>
											<table border='0' width='520px' class='product_features' style='font-family:Arial; font-size:13px; color:#30410F; float:left;' >
												...
												<tr>
													<td>Capacity (kg)</td> <td>".$detail[3]."</td>
												</tr>
												<tr>
												...
												<tr>
													<td><br><br><b>HighLights</b><br><br>Pulsator</td><td><br><br><br><br>".$detail[5]."</td>
												</tr>
												<tr>
													<td>Fuzzy logic</td> <td>Yes</td>
												</tr>
												<tr>
													<td>I-sensor</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Inner Tub</td> <td>Stainless Steel</td>
												</tr>
												<tr>
													<td>Air Dry</td> <td>With Air Dry</td>
												</tr>
												<tr>
													<td>Turbodrum</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Color</td> <td>".$detail[4]."</td>
												</tr>
												<tr>
													<td>Digital Display</td> <td>Yes</td>
												</tr>
												<tr>
													<td>3-Step Wash</td> <td>Yes</td>
												</tr>

												
												<tr>
													<td> <br><br> <b>General Specifications</b> <br><br> Turbo Soak </td> <td> <br><br><br><br>Yes</td>
												</tr>
												<tr>
													<td>Temp Selection</td> <td>Hot / Warm / Cold</td>
												</tr>
												<tr>
													<td>Hot/ Cold Water inlet</td> <td>Hot / Cold</td>
												</tr>
												<tr>
													<td>Program 1</td> <td>Fuzzy / Wool / Quick Wash / Jeans</td>
												</tr>
												<tr>
													<td>Program 2</td> <td>Smart Cleaning / Tub Clean / Silent / Favourite</td>
												</tr>
												<tr>
													<td>Water level Selection</td> <td>10</td>
												</tr>
												<tr>
													<td>Child Lock</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Memory Backup</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Auto Balance System</td> <td>Yes</td>
												</tr>
												<tr>
													<td>Window(Glass Type)</td> <td>Transparent</td>
												</tr>
									  </table>";
							}
						?>

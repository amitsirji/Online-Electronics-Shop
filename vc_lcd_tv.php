<?php
	session_start();
	$_SESSION['file_name']="vc_lcd_tv.php";
	if(!isset($_SESSION['user_name']))
	{$_SESSION['user_name']="";}
?>
<html>
<head>
<title>www.webtronic.com - Videocon LCD Television</title>
					...
					<tr>
						<td >
							...
							<?php
								...
								$temp=0;
								$col=0;
								$result=mysql_query("select * from vc_lcd_tv ");

								$count=mysql_query("select * from vc_lcd_tv");
								...
								<table border='0' style='border-color:#FF0000;'>
									...
									{	
										if($col<=2)
										{
											...
											echo " <tr><td height='120px'><center><a href='vc_lcd_tv_detail.php ? id=$data[0]'><img height='100px'  src=".$data[2]." style='border:none;'></a></center></td></tr>
											
											  <tr><td height='40px' class='font_size_12px' style='color:#618A10; border-bottom:1px solid #E4F9BB;'><center><b>".$data[1]."</b></center></td></tr>
											  
											  <tr><td height='120px' class='font_size_12px'><center><p align='left' style='padding: 5px 0 0 15px; border-bottom:1px solid #E4F9BB;'>Size : ".$data[3]."''<br>Resolution : ". $data[4]."<br>Sound : ". $data[5]."<br>Color : ". $data[6]." color</p></center></td></tr>
